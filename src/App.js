  ...
  return (
    <div>
      <header>
        ...
        <a href="#" class="logo"><i class="fas fa-utensils"></i>foodie Zone</a>
...
<!-- footer section  --> */}
      ...
      <section class="footer">
        ...
        <div class="share">
          ...
          <a href="https://twitter.com/?lang=en-in" class="btn">twitter</a>
          <a href="https://www.instagram.com/" class="btn">instagram</a>
          <a href="#" class="btn">pinterest</a>
          <a href="https://in.search.yahoo.com/search?fr=mcafee&type=E210IN826G0&p=linkedin" class="btn">linkedin</a>
        </div>

        <h1 class="credit"> created by <span> sanjana soni </span> | all rights reserved! </h1>
